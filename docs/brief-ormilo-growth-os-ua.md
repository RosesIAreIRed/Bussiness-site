# Ormilo Growth OS — бриф (історичний конспект)

> **Статус документа: архівний.** Повне ТЗ додано до repository —
> [`docs/ormilo_growth_os_technical_spec_ua.md`](ormilo_growth_os_technical_spec_ua.md) —
> і є **єдиним чинним джерелом вимог**. Цей бриф зберігається як конспект первинної
> постановки (Milestone 0 будувався за ним); у разі розбіжностей діє ТЗ.
